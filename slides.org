...
#+REVEAL_HTML: <blockquote class="citat">Young people in Denmark today are indifferent and lazy. They do not bother with politics and do not take responsibility for the development of society. This is assertations that we regularly encounter in the public debate. [...] On the contrary, we are experiencing a generation of young people who are ambitious and committed - and fully involved in society.</blockquote>

#+REVEAL_HTML: <p class="citat">Tuborg Fondet, Mandag Morgen og Netværket af Ungdomsråd (2018). Hvem sagde ung og uengageret?</p>

*** A dichotomous phenomenon?
#+ATTR_HTML: :width 1000px :class custom
[[./images/linaa-jensen.jpg]]
#+BEGIN_NOTES
Jakob Linaa Jensen: Variabler for politisk deltagelse: Diskuterer politik, medlem af politisk parti, ser tv-programmer om politik og samfund, læser aviser om politik og samfund, følger politik online (web, sociale medier), disktuerer politik online (web, sociale medier), andre. Derudover har en værdi for "Engagerer sig ikke".
#+END_NOTES
